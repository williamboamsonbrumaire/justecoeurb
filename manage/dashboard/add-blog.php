<?php include "./model/blog-crud.php"; ?>
...
<head>
  ...
  <title>Juste Coeur BeauBrun | Nouvel Article</title>
  ...
  <style>
    ...
    .tag-pill button:focus { border: none !important; }
    ...
    .darkmode .form-select         { background-color: #222235; }
      ...
      <main class="main users" id="skip-target">
        <div class="container">
          ...
          <div style="display:flex; align-items:center; justify-content:space-between; margin-bottom:24px; flex-wrap:wrap; gap:12px;">
            <h2 class="main-title" style="margin-bottom:0;">Nouvel article</h2>
            ...
            <div class="blog-layout">
              ...
              <div>
                ...
                <div class="form">
                  <div class="section-header">
                    ...
                    <div>
                      <div class="section-header__title">Contenu de l'article</div>
                      <div class="section-header__sub">Rédigez votre article avec l'éditeur riche</div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="intro" name="intro" class="form-textarea"
                              ...
                              maxlength="600" required><?= htmlspecialchars($_POST['intro'] ?? '') ?></textarea>
                  ...
                  <div class="form-group">
                    ...
                    <!-- Champ caché pour le contenu HTML -->
              ...
              <div>
                ...
                <div class="sidebar-card">
                    ...
                    <div class="statut-toggle">
                      <div class="statut-option">
                        <input type="radio" id="statut_brouillon" name="statut" value="brouillon"
                               <?= (!isset($_POST['statut']) || $_POST['statut'] === 'brouillon') ? 'checked' : '' ?>>
                      ...
                      <div class="statut-option">
                        <input type="radio" id="statut_publie" name="statut" value="publié"
                               <?= (isset($_POST['statut']) && $_POST['statut'] === 'publié') ? 'checked' : '' ?>>
                  ...
                  <button type="submit" name="add_blog" class="primary-default-btn btn-publish">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right:7px;"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                    Publier l'article
                  </button>

                  <a href="blogs.php" class="secondary-default-btn btn-draft" style="display:flex; align-items:center; justify-content:center; text-decoration:none;">
                    Annuler
                  </a>
                </div>
                ...
                <div class="sidebar-card">
                  ...
                  <div class="form-group">
                    ...
                    <select id="categorie" name="categorie" class="form-select" required>
                      <option value="" disabled <?= !isset($_POST['categorie']) ? 'selected' : '' ?>>Choisir une catégorie</option>
                      <?php
                      $categories = ['Actualité', 'Témoignage', 'Santé', 'Éducation', 'Communauté', 'Événement', 'Autre'];
                      foreach ($categories as $cat):
                        $sel = (isset($_POST['categorie']) && $_POST['categorie'] === $cat) ? 'selected' : '';
                      ?>
                ...
                <div class="sidebar-card">
                  ...
                  <div class="tags-input-wrapper" id="tagsWrapper">
                    <!-- Les pills seront injectées ici par JS -->
                    <input type="text" id="tagsInput" class="tags-real-input" placeholder="Ajouter un tag, Entrée…">
                  </div>
                  <input type="hidden" name="tags" id="tagsHidden" value="<?= htmlspecialchars($_POST['tags'] ?? '') ?>">
...
<script src="../assets/js/script.js"></script>
  ...
  // Charger le contenu précédent si erreur de soumission
  const prevContenu = <?= json_encode($_POST['contenu'] ?? '') ?>;
  if (prevContenu) quill.root.innerHTML = prevContenu;
  ...
  renderTags(); // Afficher les tags pré-remplis si erreur de soumission
  </script>
</body>
</html>