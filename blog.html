                    ...
                    <div class="blog_left_sidebar">
                       <article class="blog_item">
                        <a href="log-2.html">
                                ...
                                <img class="card-img rounded-0" src="img/blog/cover-gps.JPG" alt="">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="global-peace-summit-2026.html">
                                ...
                                <p>Juste-Coeur Beaubrun, économiste, innovateur social et directeur de Banj Labs ainsi que Katerine Vital, agronome, développeuse d'applications mobiles et mobilisatrice communautaire pour la promotion des droits des filles et des femmes en Haïti ont participé comme délégué d’Haïti au Global Peace Summit (GPS) du 29 au 31 janvier 2026 à Paris. </p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="far fa-user"></i> Diplomatie, Engagement</a></li>
                                    <li><a href="#"><i class="far fa-comments"></i> 0 Commentaires</a></li>
                                </ul>
                                   
                                <a style="color: #f1f1f1 !important;"  href="global-peace-summit-2026.html" class=" btn_1 text-white mt-3">Lire la suite</a>
                       ...
                       <article class="blog_item">
                        <a href="single-blog.html">
                                    <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/blog/Photo blog .JPG" alt="">
                                <a href="#" class="blog_item_date">
                                    <h3>11</h3>
                                    <p>Dec</p>
                                </a>
                            ...
                            <div class="blog_details">
                                ...
                                <p>Et pourquoi j’ai décidé de créer ce blog. Je m’appelle Juste-Coeur Beaubrun, né à Mare-Rouge, dans la commune du Môle-Saint-Nicolas, au Nord-Ouest d’Haïti. Issu d’une famille de six enfants, j’ai grandi dans un environnement rural où l’éducation, la discipline et l’engagement communautaire étaient les piliers du quotidien. Mes parents (Elicoeur et Françoilise) m’ont transmis des valeurs qui me guident encore aujourd’hui : persévérance, intégrité, liberté, sens du sacrifice et cohérence.</p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="far fa-user"></i> Inspiration, Biographie</a></li>
                                    <li><a href="#"><i class="far fa-comments"></i> 0 Commentaires</a></li>
                                </ul>
                                   
                                <a style="color: #f1f1f1 !important;"  href="single-blog.html" class=" btn_1 text-white mt-3">Lire la suite</a>
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <button class="btn_1" type="button"><i class="ti-search"></i></button>
                                        </div>
                                    </div>
                                </div>
